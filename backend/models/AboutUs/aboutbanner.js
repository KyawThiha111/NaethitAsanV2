...
const aboutusBannerSchema = new Schema({
    ...
    visionquoteen:{
        type:String,
        required:true,
        default:"An earthquake reminds us of nature's raw power — sudden, unstoppable, and humbling. Learn how these natural events shape our world and how we can stay prepared."
    },
    visionquotemy:{
        type:String,
        required:true,
        default:"မြေငလျင်သည် သဘာဝ၏ အံ့ဩစရာ စွမ်းအားကို ပြသပေးသော ဖြစ်ရပ်တစ်ခုဖြစ်သည်။ ထိုသဘာဝမင်းသားကို နားလည်ပြီး အဆင်သင့်ဖြစ်နေခြင်းသည် အသက်များကို ကယ်တင်နိုင်သည်။"
    },
    visiontexten:{
        type:String,
        required:true,
